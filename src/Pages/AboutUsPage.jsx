                ...
                <div className="flex items-center gap-5 mx-10">
                    <section className="w-1/2 space-y-10">
                       ...
                       <p className="text-xl text-gray-200">
                         ...
                         We are providing the platform for the aspiring teachers and stydents to share 
...
{/* carousel slide original code desiUI */}
                  {/* <div id="slide1" className="carousel-item relative w-full">
                      <div className="flex flex-col items-centre justify-centre gap-4 px-[15%]">
                       ...
                       <p className="text-xl text-gray-200">
                         {"Education is the most powerful tool you van use to change the world"}
                       </p>
                       <h3 className="text-2xl font-semibold">Nelson Mandels</h3>
