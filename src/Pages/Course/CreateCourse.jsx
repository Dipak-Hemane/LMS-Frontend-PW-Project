...
function CreateCourse() {
    ...
    return (
        <HomeLayout>
            <div className="flex items-centre justify-center h-[100vh]">
               <form
                 onSubmit={onFormSubmit}
                 className="flex flex-col justify-center gap-5 rounded-lg p-4 text-white w-[700px] my-10 shadow-[0_0_10px_black] reletive" 
               >
                    ...
                    <main className="grid grid-col-2 gap-x-10">
                        <div className="gap-y-6">
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-lg font-semobold" htmlFor="title">
                                    Course title
                                </label>
                                <input 
                                   required
                        ...
                        <div className="flex flex-col gap-1">
                           <div className="flex flex-col gap-1">
                                <label className="text-lg font-semobold" htmlFor="createdBy">
                                    Course Instructor
                                </label>
                                <input 
                                   required
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-lg font-semobold" htmlFor="category">
                                    Course category
                                </label>
                                <input 
                                   required
                            ...
                            <div className="flex flex-col gap-1">
                                <label className="text-lg font-semobold" htmlFor="description">
                                    Course description
                                </label>
                                <textarea 
                                   required
